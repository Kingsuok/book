    ...
    <article class="cl pd-20">
        <form action="" method="post" class="form form-horizontal" id="form-category-add">
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="number" class="input-text" value="" placeholder="" id="categoryNo" name="categoryNo">
                </div>
            </div>
            <div class="row cl">
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <img id="preview_id" src="{{url('_admin/static/h-ui.admin/images/icon-add.png')}}" style="border: 1px solid #B8B9B9; width: 100px; height: 100px;" onclick="$('#input_id').click()" />
...
//            parent.layer.close(index);
            $('#form-category-add').ajaxSubmit({
                ...
                url: "{{url('admin/service/category/store')}}", // 需要提交的 url
                dataType: 'json',
                data: {
