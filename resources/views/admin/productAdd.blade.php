    ...
    <article class="cl pd-20">
        <form action="" method="post" class="form form-horizontal" id="form-product-add">
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="text" class="input-text" value="" placeholder="" name="brief" datatype="*"
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="number" class="input-text" value="" placeholder="" name="price" datatype="*"
        ...
        @foreach($categorys as $category)
          ...
          @endforeach
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <img id="preview_id" src="{{url('_admin/static/h-ui.admin/images/icon-add.png')}}"
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <img id="preview_id1" src="{{url('_admin/static/h-ui.admin/images/icon-add.png')}}" style="border: 1px solid #B8B9B9; width: 80px; height: 80px;" onclick="$('#input_id1').click()" />
                    ...
                    <img id="preview_id2" src="{{url('_admin/static/h-ui.admin/images/icon-add.png')}}" style="border: 1px solid #B8B9B9; width: 80px; height: 80px;" onclick="$('#input_id2').click()" />
                    ...
                    <img id="preview_id3" src="{{url('_admin/static/h-ui.admin/images/icon-add.png')}}" style="border: 1px solid #B8B9B9; width: 80px; height: 80px;" onclick="$('#input_id3').click()" />
                    ...
                    <img id="preview_id4" src="{{url('_admin/static/h-ui.admin/images/icon-add.png')}}" style="border: 1px solid #B8B9B9; width: 80px; height: 80px;" onclick="$('#input_id4').click()" />
                    ...
                    <img id="preview_id5" src="{{url('_admin/static/h-ui.admin/images/icon-add.png')}}" style="border: 1px solid #B8B9B9; width: 80px; height: 80px;" onclick="$('#input_id5').click()" />
...
//            parent.layer.close(index);
                $('#form-product-add').ajaxSubmit({
                    ...
                    url: "{{url('admin/service/product/store')}}", // 需要提交的 url
                    dataType: 'json',
                    data: {
